...
pub struct MapMetrics {
    ...
    pub hot_index_enabled: bool,
    pub hot_mapping_seconds: f64,
    pub cold_fallback_seconds: f64,
    pub cold_fallback_reads: u64,
    pub cold_fallback_replaced_reads: u64,
    pub cold_fallback_shard_groups: u64,
    pub cold_shard_prefix_bits: u8,
    pub cold_evict_interval: u64,
    pub cold_shard_scheduling: bool,
    pub cold_preload_seconds: f64,
    ...
    pub exon_target_assignment_rate: f64,
    pub intron_target_assignment_rate: f64,
    pub gene_body_target_assignment_rate: f64,
    pub mixed_target_assignment_rate: f64,
    pub unknown_target_assignment_rate: f64,
    pub rescued_assignment_rate: f64,
